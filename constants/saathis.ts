...
export const SAATHIS: Saathi[] = [
  ...
  { id: 'mechsaathi', name: 'MechSaathi', emoji: '⚙️', tagline: 'Engineering minds, precision built', primary: '#1A3A5C', accent: '#0EA5E9', bg: '#E6EEF8', has3D: true },
  ...
  { id: 'aerospacesaathi',  name: 'AerospaceSaathi',   emoji: '✈️',  tagline: 'From ground to orbit, engineered',            primary: '#1E3A5F', accent: '#3B82F6', bg: '#EFF6FF', has3D: true },
  { id: 'electronicssaathi',name: 'ElectronicsSaathi', emoji: '📡',  tagline: 'Signals, systems, and beyond',               primary: '#312E81', accent: '#6366F1', bg: '#EEF2FF', has3D: true },
];

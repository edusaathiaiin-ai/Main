...
export type DpdpRequestType = typeof DPDP_REQUEST_TYPE[keyof typeof DPDP_REQUEST_TYPE];
...
export type LiveLectureStatus = typeof LIVE_LECTURE_STATUS[keyof typeof LIVE_LECTURE_STATUS];

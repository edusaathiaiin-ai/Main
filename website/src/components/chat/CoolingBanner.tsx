  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-2">
        <a
          href="/news"
          className="flex items-center gap-2 px-4 py-3 rounded-xl text-sm transition-all duration-150"
          style={{
        ...
        <a
          ...
          onMouseEnter={(e) => (e.currentTarget.style.background = 'rgba(201,153,58,0.2)')}
          onMouseLeave={(e) => (e.currentTarget.style.background = 'rgba(201,153,58,0.12)')}
        >

...
const STAGES = [
  {
    ...
    emoji: '🌑',
    label: 'Cold',
    desc: 'Still exploring — no clear passion direction yet.',
  },
  {
    key: 'spark',
    emoji: '✨',
    label: 'Spark',
    desc: 'Something is lighting up — curiosity is building.',
  },
  {
    key: 'flame',
    emoji: '🔥',
    label: 'Flame',
    desc: 'You have direction. Saathi is feeding it deliberately.',
  },
  {
    key: 'fire',
    emoji: '💥',
    label: 'Fire',
    desc: 'Fully committed. The journey has a destination.',
  },
  {
    key: 'wings',
    emoji: '🦋',
    label: 'Wings',
    desc: 'You have clarity, confidence, and momentum.',
  },
] as const

type FlameStage = (typeof STAGES)[number]['key']

export default function FlameStageVisual({
  stage,
}: {
  stage: FlameStage | null
}) {

  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: '260px' }}>
        <p style={{ fontSize: '14px', fontWeight: '700', color: '#C9993A', margin: '0 0 4px' }}>
          Complete your Emeritus verification
        </p>
        <p style={{ fontSize: '12px', color: 'rgba(255,255,255,0.5)', margin: '0 0 14px', lineHeight: 1.6 }}>
          Upload one document to verify your faculty credentials. Accepted: retirement letter,
          pension slip, or last appointment letter. Admin reviews within 48 hours. Until then
          your profile shows &quot;Pending Verification.&quot;
        </p>
        ...
        >
          ...
          <option value="retirement_letter">Retirement / Superannuation Letter</option>
        ...
        >
          ...
          />
          {uploading ? (
            <p style={{ fontSize: '13px', color: '#C9993A', margin: 0 }}>Uploading...</p>
          ) : (
            <>
              <p style={{ fontSize: '20px', margin: '0 0 6px' }}>📄</p>
              <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.5)', margin: 0 }}>
                {docType ? 'Drop file here or click to browse' : 'Select document type above first'}
              </p>
              <p style={{ fontSize: '11px', color: 'rgba(255,255,255,0.25)', margin: '4px 0 0' }}>

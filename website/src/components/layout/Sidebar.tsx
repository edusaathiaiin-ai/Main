...
export function Sidebar({
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ position: 'absolute', top: '10px', right: '12px', width: '8px', height: '8px', borderRadius: '50%', background: '#F87171', animation: 'pulse 2s ease infinite' }} />
      ...
      >
        ...
        <div>
          <p style={{ fontSize: '11px', fontWeight: '600', color: 'rgba(255,255,255,0.6)', margin: '0 0 1px' }}>Request a Lecture</p>
          <p style={{ fontSize: '10px', color: 'rgba(255,255,255,0.25)', margin: 0 }}>Ask your favourite faculty</p>
        </div>
      </a>
      ...
      <a
        ...
        style={{
          display: 'flex', alignItems: 'center', gap: '10px',
          margin: '4px 12px', padding: '10px 14px', borderRadius: '12px',
          background: 'rgba(37,211,102,0.08)', border: '0.5px solid rgba(37,211,102,0.25)',
      ...
      >
        ...
        <div>
          <p style={{ fontSize: '11px', fontWeight: '600', color: '#25D366', margin: '0 0 1px' }}>
            WhatsApp Saathi
          </p>

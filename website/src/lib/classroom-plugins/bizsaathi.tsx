...
function BizPlugin({ role, activeTab, onTabChange }: PluginProps) {
  ...
  const { tabs: toolTabs, render: renderToolTab } = getToolTabsFor('bizsaathi')
...
const plugin: SaathiPlugin = { Component: BizPlugin, sourceLabel: 'GeoGebra + Canvas', toolToTab: { geogebra: 'GeoGebra' } }

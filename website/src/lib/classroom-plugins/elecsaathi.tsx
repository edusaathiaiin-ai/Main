...
const BASE_TABS = ['Canvas', 'GeoGebra', 'PhET Sims', 'Falstad Circuits'] as const
...
function ElecPlugin({ role, activeTab, onTabChange }: PluginProps) {
  ...
  const { tabs: toolTabs, render: renderToolTab } = getToolTabsFor('elecsaathi')
...
const plugin: SaathiPlugin = { Component: ElecPlugin, sourceLabel: 'GeoGebra + PhET + Falstad', toolToTab: { geogebra: 'GeoGebra', phet: 'PhET Sims', falstad: 'Falstad Circuits' } }

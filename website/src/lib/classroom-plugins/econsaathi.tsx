...
function EconPlugin({ role, activeTab, onTabChange }: PluginProps) {
  ...
  const { tabs: toolTabs, render: renderToolTab } = getToolTabsFor('econsaathi')
...
const plugin: SaathiPlugin = { Component: EconPlugin, sourceLabel: 'GeoGebra + Canvas', toolToTab: { geogebra: 'GeoGebra' } }

...
function AccountPlugin({ role, activeTab, onTabChange }: PluginProps) {
  ...
  const { tabs: toolTabs, render: renderToolTab } = getToolTabsFor('accountsaathi')
...
const plugin: SaathiPlugin = { Component: AccountPlugin, sourceLabel: 'GeoGebra + Canvas', toolToTab: { geogebra: 'GeoGebra' } }

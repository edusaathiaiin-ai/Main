...
function MktPlugin({ role, activeTab, onTabChange }: PluginProps) {
  ...
  const { tabs: toolTabs, render: renderToolTab } = getToolTabsFor('mktsaathi')
...
const plugin: SaathiPlugin = { Component: MktPlugin, sourceLabel: 'GeoGebra + Canvas', toolToTab: { geogebra: 'GeoGebra' } }
